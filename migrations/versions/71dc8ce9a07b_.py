...
Revision ID: 71dc8ce9a07b
Revises: 
Create Date: 2025-01-08 18:33:33.563916
...
def upgrade():
    ...
    sa.Column('listed_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
